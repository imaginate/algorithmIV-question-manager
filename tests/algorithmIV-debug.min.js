...
/* Algorithm IV Debugger (v1.1.4) (imagineadamsmith@gmail.com)
 * Section: The Main JavaScript Module
 * Author: Adam Smith <imagineadamsmith@gmail.com>
 * Copyright (c) 2022 Adam A Smith <imagineadamsmith@gmail.com>
 * The Apache License (www.apache.org/licenses/LICENSE-2.0) */
(function(q,p){q.aIV=q.aIV||{};aIV.console=p.console;aIV.console.create=p.init;aIV.console.set=p.set;aIV.console.reset=p.reset;aIV.debug=p.init;aIV.debug.set=p.set;aIV.debug.reset=p.reset;aIV.debug.setConfig=p.set})(window,function(q,p,A){function m(){if(t)debugger;return t}var v={},t=!0,n={classTitle:"unknown",turnOffMethods:"none",addBreakpoints:"args fail",turnOnGroups:!0,openGroups:!1,turnOnProfiles:!1,turnOnTimers:!1},u={classTitle:"string",turnOffMethods:"string|!strings",addBreakpoints:"string|!strings",
turnOnGroups:"boolean",openGroups:"boolean",turnOnProfiles:"boolean",turnOnTimers:"boolean"},w=aIV.utils.freezeObj,h=aIV.utils.hasOwnProp,e=aIV.utils.checkType,x=aIV.utils.isValidTypeString,y=aIV.utils.getTypeOf,z=function(){var a,b;a={errorBreakpoints:"errorBreakpoints",errorDebuggers:"errorBreakpoints",className:"classTitle",turnOffTypes:"turnOffMethods",turnOnDebuggers:"addBreakpoints",formatElementsAsObj:"formatElementsAsObj"};for(b in n)h(n,b)&&(a[b]=b);return function(b){var d,f;if(e(b,"?null="))for(f in d=
[],a)h(a,f)&&d.push(a[f]);else if(e(b,"!strings"))for(d=[],b=b.length;b--;)f=args[b],h(a,f)&&d.push(a[f]);else d=null;return d}}();q={console:{},init:function(a){var b;e(a,"?(string|object)")||(a=null);b=d.defaults.classTitle;e(a,"string")&&(b=a,a=null);a&&(a=d.replaceOldSettings(a),a.classTitle&&e(a.classTitle,"string")&&(b=a.classTitle));if(!h(v,b)){var c=b,k,f,g,r;k={};f=d.defaults;for(g in f)h(f,g)&&(k[g]=f[g]);if(a)for(g in a)h(a,g)&&h(f,g)&&(r=a[g],e(r,u[g])&&(e(r,"!strings")&&(r=r.join(" ")),
k[g]=r));k.classTitle=c;v[c]=new d(k)}return v[b]}};q.set=function(){var a,b;b={errorBreakpoints:function(a){e(a,"boolean")&&(t=a)},formatElementsAsObj:function(a){e(a,"boolean")&&(d.formatElementsAsObj=a)}};for(a in u)h(u,a)&&(b[a]=function(a,b){return function(f){e(f,b)&&(e(f,"!strings")&&(f=f.join(" ")),d.defaults[a]=f)}}(a,u[a]));return function(a){var k,f;if(e(a,"!object"))for(k in h(a,"errorDebuggers")&&!h(a,"errorBreakpoints")&&(a.errorBreakpoints=a.errorDebuggers),a=d.replaceOldSettings(a),
a)h(a,k)&&h(b,k)&&(f=a[k],b[k](f));else l.setConsoleTypeError(y(a)),m()}}();q.reset=function(){var a,b;b={errorBreakpoints:function(){t=!0},formatElementsAsObj:function(){d.formatElementsAsObj=!0}};for(a in n)h(n,a)&&(b[a]=function(a){return function(){d.defaults[a]=n[a]}}(a));return function(){var a,d,e;a=(a=arguments.length)?1<a?Array.prototype.slice.call(arguments,0):Array.isArray(arguments[0])?arguments[0]:[arguments[0]]:null;if(a=z(a))for(e=a.length;e--;)d=a[e],b[d]();else l.resetConsoleTypeError(),
m();return!!a}}();var l={setConsoleTypeError:function(a){var b;b="An aIV.console.set call was missing a valid object for the new settings parameter (the first and only parameter). It should be an object with string => value pairs that match the module ";b+="properties you want to set and their new value (e.g. property ";b+="=> value). The invalid settings data type was '";b+=a+"'";throw new TypeError(b);},resetConsoleTypeError:function(){throw new TypeError("An aIV.console.reset call received an invalid setting parameter (should be a string or an array of strings).");
},invalidGetName:function(a,b){var c;c="An aIV.console "+a+" call was missing a valid method or type name parameter (the first parameter). It should be a ";c+="string of the method/type name that "+a+" is to get. ";return c+="The invalid name was '"+b+"'."},missingMethodName:function(a,b){var c;c="An aIV.console "+a+" call was missing a valid method name parameter (the first parameter). It should be a string ";c+="of the method's name that "+a+" is recording. The ";c+="invalid method name parameter's data type follows: ";
return c+=null===b?"null":typeof b},missingTypeStrings:function(a){a="An aIV.console "+a+" call was missing valid data type strings to use for testing arguments. For all arguments ";a+="you should include a string of each argument's possible data ";a+="types (e.g. '!string|object') as a parameter immediately ";return a+="following the argument parameter."},missingTestArgs:function(){var a;a="An aIV.console args call was missing arguments to test. The args method requires that at least one argument be tested. After the first parameter (the method name), the ";
a+="second parameter should be an argument to test, and the ";a+="third parameter should be a string of the argument's ";a+="optional data types. You can include as many pairs of ";return a+="arguments and optional data types as you like."},invalidGroupType:function(a){var b;b="An aIV.console group call was given an incorrect group type value for its second parameter. The  group's data type was '";b+=null===a?"null":typeof a;b+="',  and its value converted to a string was '";b+=a+"'. It should be either 'open', 'coll', ";
return b+="or 'end'."},missingErrorMessage:function(a){var b;b="An aIV.console fail call was missing a valid log message parameter (its third parameter). It should be a string of the error message to log upon test failure. The ";b+="invalid message's data type was '";b+=null===a?"null":typeof a;return b+="'"},missingStateValues:function(){var a;a="An aIV.console state call was missing a state to log. After the first parameter (the method name), the second parameter should be a log message with $$ in the places where you would ";
...
c+="of strings of the method/type name that "+a+" is to ";return c+="update. The invalid names follow: "+b}};w(l,!0);var d=function(a){this.classTitle=a.classTitle+".";this.openGroups=a.openGroups;var b,c,d,f,g;a.turnOffMethods=a.turnOffMethods.toLowerCase();a.addBreakpoints=a.addBreakpoints.toLowerCase();b={init:!/init|all/.test(a.turnOffMethods),start:!/start|all/.test(a.turnOffMethods),end:!/end|all/.test(a.turnOffMethods),args:!/args|all/.test(a.turnOffMethods),fail:!/fail|all/.test(a.turnOffMethods),
group:!/group|all/.test(a.turnOffMethods),state:!/state|all/.test(a.turnOffMethods),misc:!/misc|all/.test(a.turnOffMethods)};c={init:/init|all/.test(a.addBreakpoints),start:/start|all/.test(a.addBreakpoints),end:/end|all/.test(a.addBreakpoints),args:/args|all/.test(a.addBreakpoints),fail:/fail|all/.test(a.addBreakpoints),group:/group|all/.test(a.addBreakpoints),state:/state|all/.test(a.addBreakpoints),misc:/misc|all/.test(a.addBreakpoints)};d=a.turnOnGroups;f=a.turnOnProfiles;g=a.turnOnTimers;this.getMethod=
function(a){if(e(a,"string")&&h(b,a))return b[a];console.error(l.invalidGetName("getMethod",a));m()};this.getBreakpoint=function(a){if(e(a,"string")&&h(c,a))return c[a];console.error(l.invalidGetName("getBreakpoint",a));m()};this.getAuto=function(a){var b;b={groups:d,profiles:f,timers:g};if(e(a,"string")&&h(b,a))return b[a];console.error(l.invalidGetName("getAuto",a));m()};this.setMethod=function(a,c){if(!e(a,"string")||!e(c,"boolean"))return!1;a=a.toLowerCase();if(!h(b,a)&&"all"!==a)return!1;if("all"===
a)for(a in b)h(b,a)&&(b[a]=c);else b[a]=c;return!0};this.setBreakpoint=function(a,b){if(!e(a,"string")||!e(b,"boolean"))return!1;a=a.toLowerCase();if(!h(c,a)&&"all"!==a)return!1;if("all"===a)for(a in c)h(c,a)&&(c[a]=b);else c[a]=b;return!0};this.setAuto=function(a,b){var c;c={groups:function(a){d=a},profiles:function(a){f=a},timers:function(a){g=a}};if(!e(a,"string")||!e(b,"boolean"))return!1;a=a.toLowerCase();if(!h(c,a)&&"all"!==a)return!1;if("all"===a)for(a in c){if(h(c,a))c[a](b)}else c[a](b);
return!0};w(this,!0)};d.prototype.constructor=d;d.prototype.init=function(a){var b,c,k,f;e(a,"!string|array")&&(e(a,"string")?c=1<arguments.length?Array.prototype.slice.call(arguments,1):[]:(c=1<a.length?a.slice(1):[],a=a[0]));if(e(a,"string")){if((b=c.length)&&(b%2||!d.checkArgsDataTypeStrings(c))){console.error(l.missingTypeStrings("init"));m();return}if(!this.getMethod("init"))return d.handleAuto.call(this,"groups",a),d.handleAuto.call(this,"profiles",a),d.handleAuto.call(this,"timers",a),!1;d.handleAuto.call(this,
"groups",a);k=b?d.testArgTypes(c):!0;k||(f="ARGS: "+this.classTitle+a+"() | ",console.error(f+"Error: Incorrect argument data type."),d.insertBreakpoint.call(this,"init args"));b&&(c=d.stripArgTypeStrings(c));f="CALL: "+this.classTitle+a;f+="("+d.makeSubstituteStrings(c)+")";c.unshift(f);console.log.apply(console,c);d.insertBreakpoint.call(this,"init");d.handleAuto.call(this,"profiles",a);d.handleAuto.call(this,"timers",a);return!k}console.error(l.missingMethodName("init",a));m()};d.prototype.start=
function(a){var b,c;e(a,"!string|array")&&(e(a,"string")?b=1<arguments.length?Array.prototype.slice.call(arguments,1):[]:(b=1<a.length?a.slice(1):[],a=a[0]));if(e(a,"string")){if(!this.getMethod("start"))return d.handleAuto.call(this,"groups",a),d.handleAuto.call(this,"profiles",a),d.handleAuto.call(this,"timers",a),!1;d.handleAuto.call(this,"groups",a);c="CALL: "+this.classTitle+a;c+="("+d.makeSubstituteStrings(b)+")";b.unshift(c);console.log.apply(console,b);d.insertBreakpoint.call(this,"start");
d.handleAuto.call(this,"profiles",a);d.handleAuto.call(this,"timers",a);return!0}console.error(l.missingMethodName("start",a));m()};d.prototype.end=function(a,b){var c;e(a,"!array")&&(1<a.length&&(b=a[1]),a=a[0]);if(e(a,"string")){if(!this.getMethod("end"))return d.handleAuto.call(this,"timers",a,!0),d.handleAuto.call(this,"profiles",a,!0),d.handleAuto.call(this,"groups",a,!0),!1;c="END: "+this.classTitle+a+"() | ";c+="return= "+d.getSubstituteString(b);console.log(c,b);d.insertBreakpoint.call(this,
"end");d.handleAuto.call(this,"timers",a,!0);d.handleAuto.call(this,"profiles",a,!0);d.handleAuto.call(this,"groups",a,!0);return!0}console.error(l.missingMethodName("end",a));m()};d.prototype.args=function(a){var b;e(a,"!string|array")&&(e(a,"string")?b=1<arguments.length?Array.prototype.slice.call(arguments,1):[]:(b=1<a.length?a.slice(1):[],a=a[0]));if(e(a,"string"))if(2>b.length)console.error(l.missingTestArgs()),m();else if(b.length%2||!d.checkArgsDataTypeStrings(b))console.error(l.missingTypeStrings("args")),
m();else{if(!this.getMethod("args")||d.testArgTypes(b))return!1;b="ARGS: "+this.classTitle+a+"() | ";console.error(b+"Error: Incorrect argument data type.");d.insertBreakpoint.call(this,"args");return!0}else console.error(l.missingMethodName("args",a)),m()};d.prototype.fail=function(a,b,c){var k;e(a,"!string|array")&&(e(a,"string")?(b=e(b,"function")?!!b():!!b,k=3<arguments.length?Array.prototype.slice.call(arguments,3):[]):(b=a[1],b=e(b,"function")?!!b():!!b,c=a[2],k=3<a.length?a.slice(3):[],a=a[0]));
if(e(a,"string")){if(!e(c,"string"))return console.error(l.missingErrorMessage(c)),m(),!1;if(!this.getMethod("fail")||b)return!1;k.length&&(c=d.insertSubstituteStrings(c,k));c="FAIL: "+this.classTitle+a+"() | "+c;k.unshift(c);console.error.apply(console,k);d.insertBreakpoint.call(this,"fail");return!0}console.error(l.missingMethodName("fail",a));m()};d.prototype.group=function(a,b,c){var k,f;k={open:"open",coll:"coll",end:"end"};e(a,"!string|array")&&(e(a,"string")?(e(b,"undefined")&&(b="open"),e(c,
"undefined")&&(c=""),f=3<arguments.length?Array.prototype.slice.call(arguments,3):[]):(b=1<a.length?a[1]:"open",c=2<a.length?a[2]:"",f=3<a.length?a.slice(3):[],a=a[0]),e(c,"string")||(f.unshift(c),c=""));if(e(a,"string")){if(e(b,"string")&&h(k,b)){if(!this.getMethod("group"))return!1;if("end"===b)return console.groupEnd(),!0;if(c||f.length)f.length&&(c=d.insertSubstituteStrings(c,f)),c=" | "+c;c="GROUP: "+this.classTitle+a+"()"+c;f.unshift(c);"coll"===b?console.groupCollapsed.apply(console,f):console.group.apply(console,
f);d.insertBreakpoint.call(this,"group");return!0}console.error(l.invalidGroupType(b))}else console.error(l.missingMethodName("group",a));m()};d.prototype.state=function(a,b){var c;e(a,"!string|array")&&(e(a,"string")?c=2<arguments.length?Array.prototype.slice.call(arguments,2):[]:(b=1<a.length?a[1]:"",c=2<a.length?a.slice(2):[],a=a[0]),e(b,"string")||(c.unshift(b),b=""));if(e(a,"string")){if(c.length){if(!this.getMethod("state"))return!1;b=d.insertSubstituteStrings(b,c);b="STATE: "+this.classTitle+
a+"() | "+b;c.unshift(b);console.log.apply(console,c);d.insertBreakpoint.call(this,"state");return!0}console.error(l.missingStateValues())}else console.error(l.missingMethodName("state",a));m()};d.prototype.misc=function(a,b){var c;e(a,"!string|array")&&(e(a,"string")?c=2<arguments.length?Array.prototype.slice.call(arguments,2):[]:(b=1<a.length?a[1]:"",c=2<a.length?a.slice(2):[],a=a[0]),e(b,"string")||(c.unshift(b),b=""));if(e(a,"string")){if(b||c.length){if(!this.getMethod("misc"))return!1;c.length&&
(b=d.insertSubstituteStrings(b,c));b="MISC: "+this.classTitle+a+"() | "+b;c.unshift(b);console.log.apply(console,c);d.insertBreakpoint.call(this,"misc");return!0}console.error(l.missingLogMessage(b))}else console.error(l.missingMethodName("misc",a));m()};d.prototype.turnOnMethod=function(a){var b;b=this;1<arguments.length?a=Array.prototype.slice.call(arguments,0).join(" "):e(a,"!strings")&&(a=a.join(" "));return d.handleToggle("turnOnMethod",function(a){return b.setMethod(a,!0)},a)};d.prototype.turnOn=
d.prototype.turnOnMethod;d.prototype.turnOffMethod=function(a){var b;b=this;1<arguments.length?a=Array.prototype.slice.call(arguments,0).join(" "):e(a,"!strings")&&(a=a.join(" "));return d.handleToggle("turnOffMethod",function(a){return b.setMethod(a,!1)},a)};d.prototype.turnOff=d.prototype.turnOffMethod;d.prototype.addBreakpoint=function(a){var b;b=this;1<arguments.length?a=Array.prototype.slice.call(arguments,0).join(" "):e(a,"!strings")&&(a=a.join(" "));return d.handleToggle("addBreakpoint",function(a){return b.setBreakpoint(a,
!0)},a)};d.prototype.turnOnDebugger=d.prototype.addBreakpoint;d.prototype.removeBreakpoint=function(a){var b;b=this;1<arguments.length?a=Array.prototype.slice.call(arguments,0).join(" "):e(a,"!strings")&&(a=a.join(" "));return d.handleToggle("removeBreakpoint",function(a){return b.setBreakpoint(a,!1)},a)};d.prototype.turnOffDebugger=d.prototype.removeBreakpoint;d.prototype.turnOnAuto=function(a){var b;b=this;1<arguments.length?a=Array.prototype.slice.call(arguments,0).join(" "):e(a,"!strings")&&(a=
a.join(" "));return d.handleToggle("turnOnAuto",function(a){return b.setAuto(a,!0)},a)};d.prototype.turnOffAuto=function(a){var b;b=this;1<arguments.length?a=Array.prototype.slice.call(arguments,0).join(" "):e(a,"!strings")&&(a=a.join(" "));return d.handleToggle("turnOffAuto",function(a){return b.setAuto(a,!1)},a)};d.defaults={classTitle:n.classTitle,turnOffMethods:n.turnOffMethods,addBreakpoints:n.addBreakpoints,turnOnGroups:n.turnOnGroups,openGroups:n.openGroups,turnOnProfiles:n.turnOnProfiles,
turnOnTimers:n.turnOnTimers};d.autoSettings={};d.autoSettings.groups={msgTitle:"GROUP",startFunc:function(a,b){b?console.group(a):console.groupCollapsed(a)},endFunc:function(){console.groupEnd()}};d.autoSettings.profiles={msgTitle:"PROFILE",startFunc:function(a){console.profile(a)},endFunc:function(){console.profileEnd()}};d.autoSettings.timers={msgTitle:"TIME",startFunc:function(a){console.time(a)},endFunc:function(a){console.timeEnd(a)}};d.formatElementsAsObj=!0;d.replaceOldSettings=function(){var a;
a={className:"classTitle",turnOffTypes:"turnOffMethods",turnOnDebuggers:"addBreakpoints"};return function(b){var c,d;for(c in a)h(a,c)&&h(b,c)&&(d=a[c],h(b,d)||(b[d]=b[c]));return b}}();d.insertBreakpoint=function(){var a;a=/\s/;return function(b){var c,d;d=a.test(b)?b.split(" "):[b];b=!1;for(c=d.length;c--;)if(b=d[c],b=this.getBreakpoint(b)){debugger;break}return b}}();d.handleAuto=function(a,b,c){var e,f;if(e=this.getAuto(a))f=d.autoSettings[a].msgTitle+": ",f+=this.classTitle+b,c?d.autoSettings[a].endFunc(f):
d.autoSettings[a].startFunc(f,this.openGroups);return e};d.handleToggle=function(a,b,c){var d,f,g;if(e(c,"string")){c=c.split(" ");d=c.length;for(f=-1;++f<d;)b(c[f])||(g||(g=[]),g.push("'"+c[f]+"'"));g&&(g=g.join(", "));if(g)console.error(l.invalidSetName(a,g)),m();else return!0}else console.error(l.invalidSetName(a,c)),m()};d.getSubstituteString=function(a){return e(a,"!object|function")?!d.formatElementsAsObj&&a instanceof HTMLElement?"%o":"%O":"%s"};d.makeSubstituteStrings=function(a){var b,c,
e;e="";c=a.length;for(b=-1;++b<c;)b&&(e+=", "),e+=d.getSubstituteString(a[b]);return e};d.insertSubstituteStrings=function(){var a;a=/([^\\]*?)\$\$/;return function(b,c){var e,f,g;e=c.length;for(f=-1;++f<e;)g=d.getSubstituteString(c[f]),a.test(b)?(g="$1"+g,b=b.replace(a,g)):b+="; unnamedVar"+f+"= "+g;return b}}();d.checkArgsDataTypeStrings=function(a){var b,c;c=!0;for(b=a.length;b--&&(b%2&&(c=(c=e(a[b],"string",!0))&&x(a[b])),c););return c};d.testArgTypes=function(a){var b,c;c=!0;for(b=a.length;b--&&
(c=a[b],--b,c=e(a[b],c,!0),c););return c};d.stripArgTypeStrings=function(a){var b,c,d;c=a.length/2;d=Array(c);for(b=a.length;c--;)b-=2,d[c]=a[b];return d};return q}(window,document));
