      ...
      solution: function() {
        ...
        function heapify(start, end) {
          ...
          while (left <= end) {
            ...
            // Set max
            max = (heap[left] > heap[pNode]) ? left : pNode;
            ...
            if (right <= end) {
              max = (heap[right] > heap[max]) ? right : max;
            }
            ...
            // Swap node values
            heap[max] = ( heap[pNode] + (heap[pNode] = heap[max]) ) - heap[max];
